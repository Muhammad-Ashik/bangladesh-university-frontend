    ...
    <footer className='container-fluid xs:px-7 lg:px-14 pt-14 bg-black text-[#ededed] m-0'>
      <div className='container mx-auto grid xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 space-y-6 mb-5'>
        <div className='flex flex-col justify-start'>
          ...
          <p className='text-sm leading-7 my-3 text-justify'>
            Explore the endless possibilities and embark on an adventure of
            knowledge and innovation. Discover a vibrant community committed to
            academic success and transform your goals into reality with us. Join
            our renowned university, a center of excellence for higher
            education.
          </p>
        </div>
        <div className='xs:mx-0 md:mx-auto'>
          <h3 className='text-xl pb-3 font-bold'>Pages</h3>
          <ul className='space-y-4 text-sm'>
            {['About Us', 'Programs', 'Admissions', 'Contact'].map((page) => (
              <li key={page}>
                <Link href='#'>{page}</Link>
              </li>
            ))}
        ...
        <div className='xs:mx-0 md:mx-auto md:order-last lg:order-none'>
          <h3 className='text-xl pb-3 font-bold'>Links</h3>
          <ul className='space-y-4 text-sm'>
            {['Academics', 'Admission', 'About BU', 'Contact'].map((link) => (
              <li key={link}>
                <Link href='#'>{link}</Link>
              </li>
            ))}
        ...
        <div className='xs:space-y-2 md:space-y-4'>
          ...
          <div className='flex items-center'>
            ...
            <p className='text-sm pl-4'>cse@bu.edu.bd</p>
          </div>
          <div className='flex items-center'>
            <svg
              width='14'
            ...
            <p className='text-sm pl-4'>+88 01755-559301, +88 01755-559312</p>
          </div>
          <div className='flex items-start'>
            ...
            <p className='text-sm leading-7 ml-4'>
              5/B, Beribandh Main Road, <br /> Adabar, Mohammadpur, Dhaka - 1207
            </p>
          </div>
          <div className='flex'>
            <Link href='#' className='bg-primary rounded-[50%] m-1 p-1 md:p-2'>
              <svg
                width='24'
                height='24'
                viewBox='0 0 24 24'
