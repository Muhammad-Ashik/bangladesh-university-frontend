...
export default function Founder() {
  return (
    <div className='container max-w-[1400px] mx-auto mt-20 xs:mb-20 xl:mb-40 xs:px-6 sm:px-12'>
      <h2 className='text-secondary text-30 font-bold mb-8'>
      ...
      <div className='grid grid-cols-5 gap-10'>
        <div className='max-h-96 md:max-h-[600px] lg:col-span-2 xs:col-span-5'>
          ...
          <div className='my-8 space-y-2 text-center'>
            <h2 className='text-secondary text-24 uppercase font-bold'>
              QUAZI Azher Ali
            </h2>
            <p className='text-gray-500 text-14 text-center uppercase'>
        ...
        <div className='lg:col-span-3 space-y-5 xs:col-span-5 xs:mt-20 lg:mt-0'>
          {founderData.map((data, index) => (
            <div key={index}>
              <h3 className='text-secondary text-24'>{data.title}</h3>
              <p className='text-16 leading-7 md:leading-8 text-justify text-gray-500'>
                {data.description}
              </p>
            </div>
          ))}
