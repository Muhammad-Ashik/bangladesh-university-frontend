...
import { examControlOfficeData } from './examControlOfficeData'

export default function ExamControlOffice() {
  return (
    <div className='container max-w-[1400px] mx-auto py-14 p-4 sm:px-5'>
      <Image
        src='/images/exam-control-office/exam-controller.png'
        width={500}
        height={500}
        alt='exam-controller'
      />
      <h2 className='title-40 font-bold text-secondary mb-10 mt-5'>
        Message from the Exam Controller
      </h2>
      <div>
      ...
      <div className='my-28 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-7'>
        {examControlOfficeData.map((data, index) => (
